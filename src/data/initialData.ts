...
export const INITIAL_ADMINS: AdminUser[] = [
  INITIAL_SUPER_ADMIN_USER,
  {
    ...
    email: 'ali.raza@iso.org.pk',
    phone: '03001234567',
    designation: 'Central General Secretary',
    isSuperAdmin: false,
    role: 'Admin',
    permissions: {
      manageMembers: true,
    ...
    lastActive: '2026-07-20T10:15:00Z'
  },
  {
    id: 'ADM-0003',
    name: 'Syed Hasan Zaidi',
    email: 'hasan.zaidi@iso.org.pk',
    phone: '03219876543',
    designation: 'Provincial Coordinator Sindh',
    isSuperAdmin: false,
    role: 'Manager',
    permissions: {
      manageMembers: true,
    ...
    lastActive: '2026-07-21T14:20:00Z'
  }
];
...
export const INITIAL_OFFICE_BEARERS: OfficeBearer[] = [
  ...
  {
    id: 'ISO-OB-2026-002',
    name: 'Syed Ghulam Mustafa Shah',
    designation: 'Central President (Sadr-e-Markaz)',
    mobileNumber: '03002211445',
    whatsapp: '03002211445',
    city: 'Islamabad',
