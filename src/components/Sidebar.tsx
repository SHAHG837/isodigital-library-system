    ...
    ...(!isRegularMember ? [
      {
        ...
        items: [
          ...(isSuperAdmin ? [{ id: 'superAdmin' as ActiveTab, label: 'Super Administrator', icon: ShieldCheck, highlight: true }] : []),
          { 
            id: 'adminRbac' as ActiveTab, 
            label: 'Admin Security (RBAC)', 
            icon: UserCheck, 
            badge: isSuperAdmin ? 'Full Control' : 'Super Admin Only' 
          },
